...
type ParseReqRespCallback func(rr *httpmsg.HttpRequestResponse) bool
...
// Counter is an optional interface for formats that can pre-count items.
type Counter interface {
	Count(input string) (int64, error)
}
